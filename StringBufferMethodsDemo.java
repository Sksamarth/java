class StringBufferMethodsDemo { 
 ...
 // 4. replace() – Replace characters between start and end indices  sb.replace(5, 13, "Script"); 
 System.out.println("4. After replace(): " + sb); 
 // 5. delete() – Remove characters between given indices  sb.delete(0, 5); 
 ...
 // 12. setCharAt() – Change a character at a specific index  sb.setCharAt(0, 'K'); 
 System.out.println("12. After setCharAt(0, 'K'): " + sb); 
 // 13. substring() – Extract part of the sequence 
 System.out.println("13. substring(4): " + sb.substring(4));  System.out.println(" substring(4, 10): " + sb.substring(4, 10)); 
 // 14. deleteCharAt() – Remove character at given index  sb.deleteCharAt(0); 
 System.out.println("14. After deleteCharAt(0): " + sb); 
 // 15. append() with multiple types (method overloading)  sb.append(" Example ").append(2025).append(' ').append(true);  System.out.println("15. After multiple appends: " + sb); 
 // 16. capacity grows automatically when exceeded 
 System.out.println("16. Capacity before large append: " + sb.capacity());  sb.append(" This text is to check automatic capacity increment.");  System.out.println(" Capacity after large append: " + sb.capacity()); 
